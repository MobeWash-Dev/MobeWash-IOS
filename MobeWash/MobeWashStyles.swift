...
class MWColors {
    ...
    static let MWLightestBlue = UIColor(red: 0 / 255 , green: 114 / 255 , blue: 150 /
        255 , alpha: 1.0 )
    static let MWLightBlue = UIColor(red: 0 / 255 , green: 114 / 255 , blue: 190 / 255 , alpha: 1.0 )
    static let MWDarkBlue = UIColor(red: 0 / 255 , green: 114 / 255 , blue: 240 / 255 , alpha: 1.0 )
...
class MWStyles {
    ...
    static let normalButtonBackgroundColor = MWColors.MWDarkBlue
    static let importantButtonBackgroundColor = MWColors.MWOrange
    static let buttonTextColor = MWColors.MWBlue
}
