...
class WorkListViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let work1 = Work(workTitle: "Super Wash", workTime: "3pm,Thursday", workLoc: "9500 Gilman Drive, Rimac Annex, San Diego CA 92093, United States", package: "DayDreams",carInfo:carinfo1)
        let work2 = Work(workTitle: "job2", workTime: "5pm,Thursday", workLoc: "3904 Convoy St, San Diego, CA 92111", package: "DayDream",carInfo:carinfo2)
        let work3 = Work(workTitle: "job3", workTime: "6pm,Thursday", workLoc: "8055 Armour St, San Diego, CA 92111", package: "DayDream", carInfo:carinfo3)
